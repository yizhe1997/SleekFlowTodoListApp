...
namespace SleekFlowTodoListAPI.Infrastructure.Mediatr
{
    ...
    {
        public SearchRequestHandler(DatabaseContext dbContext, IMapper mapper, IHttpContextAccessor httpContext, CurrentContext userAccessor) : base(dbContext, mapper, httpContext, userAccessor)
        {
        }
