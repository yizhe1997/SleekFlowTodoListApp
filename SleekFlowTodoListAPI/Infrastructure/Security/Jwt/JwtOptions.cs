...
namespace SleekFlowTodoListAPI.Infrastructure.Security.Jwt
{
    public class JwtOptions
    {
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 14 days)
        /// </summary>
        public int ValidForDays { get; set; } = 14;
        ...
        public DateTime Expires => IssuedAt.Add(TimeSpan.FromDays(ValidForDays));
        ...
        /// <summary>
        /// The secret key used to create signing credentials.
        /// </summary>
        ...
        /// </summary>
        public SigningCredentials SigningCredentials => new SigningCredentials(new SymmetricSecurityKey(Encoding.UTF8.GetBytes(SecretKey ?? string.Empty)), SecurityAlgorithms.HmacSha256);
    }
}
